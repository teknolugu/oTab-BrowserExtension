        ...
        <div class="el-list">
            ...
            <div class="el-list-item select">
                <div class="element-select">
                    <el-select multiple :multiple-limit="5 - items.tags.length" size="small" collapse-tags placeholder="Add item tag" v-model="select" filterable :disabled="items.tags.length === 5">
